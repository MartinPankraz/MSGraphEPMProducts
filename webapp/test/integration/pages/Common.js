sap.ui.define([
	...
	return Opa5.extend("msgraphepmproducts.msgraphepmproducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["msgraphepmproducts/msgraphepmproducts/localService/mockserver"], function (mockserver) {
