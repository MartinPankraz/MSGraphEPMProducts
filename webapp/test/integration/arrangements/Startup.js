sap.ui.define([
	"sap/ui/test/Opa5",
	"msgraphepmproducts/msgraphepmproducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("msgraphepmproducts.msgraphepmproducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "msgraphepmproducts.msgraphepmproducts",
					async: true
				},
				hash: oOptions.hash,
