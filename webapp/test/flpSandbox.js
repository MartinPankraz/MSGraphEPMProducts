		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Link SAP EPM Products with Exchange Online Feeds",
									"targetURL": "#LinkSAPEPMProductswithExchangeOnlineFeeds-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LinkSAPEPMProductswithExchangeOnlineFeeds-display": {
								"semanticObject": "LinkSAPEPMProductswithExchangeOnlineFeeds",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=msgraphepmproducts.msgraphepmproducts",
									"url": sap.ui.require.toUrl("msgraphepmproducts/msgraphepmproducts")
								}
							}
						}
					}
